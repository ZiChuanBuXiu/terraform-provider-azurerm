...
* `id` - The ID of the Cognitive Services Project Connection.

## Timeouts

The `timeouts` block allows you to specify [timeouts](https://developer.hashicorp.com/terraform/language/resources/configure#define-operation-timeouts) for certain actions:

* `create` - (Defaults to 30 minutes) Used when creating the Cognitive Services Project Connection.
* `read` - (Defaults to 5 minutes) Used when retrieving the Cognitive Services Project Connection.
* `update` - (Defaults to 30 minutes) Used when updating the Cognitive Services Project Connection.
* `delete` - (Defaults to 30 minutes) Used when deleting the Cognitive Services Project Connection.
