...
description: |-
  Lists Cognitive Account Project Connection resources that use project managed identity authentication.
---

# List resource: azurerm_cognitive_account_project_connection_project_managed_identity
...
```hcl
list "azurerm_cognitive_account_project_connection_project_managed_identity" "example" {
  provider = azurerm
  config {
